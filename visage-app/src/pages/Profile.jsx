...
function Profile(props){
  ...
  return (
    <div>
        ...
        <ProfileWhole myId={props.myId} className='profileDisplay' inConnectionPage={props.inConnectionPage} id={props.id} session={props.session}/>
        <br />
        ...
        <div className={lineClass}>
          <UserStats myId={props.myId} inConnectionPage={props.inConnectionPage} id={props.id} session={props.session}/>
        </div>
